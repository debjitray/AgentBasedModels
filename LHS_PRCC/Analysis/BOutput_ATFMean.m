...
for MAIN=round([4.01:8.61:72.89]*24)
    ...
    MEAN_UNDIFF=mean(CUMM_UNDIFF)';
    MEAN_DIFF=mean(CUMM_DIFF)';
    MEAN_PRELEP=mean(CUMM_PRELEP)';
    MEAN_LEP=mean(CUMM_LEP)';
    MEAN_ZYG=mean(CUMM_ZYG)';
    MEAN_PACHY=mean(CUMM_PACHY)';
    MEAN_DIP=mean(CUMM_DIP)';
    MEAN_SEC=mean(CUMM_SEC)';
    MEAN_ROUND=mean(CUMM_ROUND)';
    MEAN_ELONG=mean(CUMM_ELONG)';
