...
for (i in 1:9) {
	...
	pdf(file=paste('Z.Number_ATFSUM/4.HeatMap_',TIMEFRAME[i],'.pdf',sep=""),width=30,height=20,pointsize=20);
	...
	pdf(file=paste('Z.Number_ATFSUM/0.Verifier_',TIMEFRAME[i],'.pdf',sep=""),width=30,height=20,pointsize=20);
