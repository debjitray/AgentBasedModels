...
% COMMENTED LINE 15 BY DEBJIT RAY TO MAKE IT SPECIFIC FOR ONE TIME FRAME,
% OTHERWISE EXACTLY SIMILAR TO PRCC.M

function [prcc sign sign_label]=PRCC1(LHSmatrix,Y,s,PRCC_var,alpha);
